...
| Check | Result |
|-------|--------|
| `pnpm -C frontend test` | **Pass** (242 tests) |
| `pnpm -C frontend typecheck` | **Fail** — pre-existing editor/schema typing debt (unrelated to view-mode/Duplicate) |
| `pnpm -C frontend lint` | **Fail** — pre-existing ESLint issues |
| `pnpm -C frontend build` | **Fail** — blocked by typecheck |

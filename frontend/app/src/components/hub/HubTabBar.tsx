...
type HubTabTo = '/collections' | '/songs' | '/setlists' | '/rooms'
...
const tabs = [
  ...
  { to: '/rooms' as const, labelKey: 'hub.tabs.rooms' as const, Icon: IconHubRooms },
] satisfies ReadonlyArray<{
  to: HubTabTo
  labelKey: 'hub.tabs.collections' | 'hub.tabs.songs' | 'hub.tabs.setlists' | 'hub.tabs.rooms'
  Icon: typeof IconHubCollections
}>

function isRoomsTabActive(pathname: string): boolean {

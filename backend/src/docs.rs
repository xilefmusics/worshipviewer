...
use shared::player_room::{
    ...
    PlayerRoomSnapshot, PlayerRoomSongPool, PlayerRoomSongPoolSelection, PlayerRoomSourceType,
    PlayerRoomSummary, UpdatePlayerRoomSongPool,
};
use shared::setlist::{
...
#[openapi(
    ...
    paths(
        ...
        crate::resources::player_room::rest::update_song_pool,
        crate::resources::player_room::rest::get_pool_songs,
        crate::resources::player_room::rest::close_room,
        crate::resources::player_room::rest::add_queue_item,
        crate::resources::player_room::rest::promote_queue_item,
        crate::resources::player_room::rest::remove_queue_item,
        crate::resources::player_room::rest::reorder_queue,

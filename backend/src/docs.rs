...
use shared::room::{
    ...
    RoomProjectionPayload, RoomSnapshot, RoomSongPool, RoomSongPoolSelection, RoomSourceType,
    RoomSummary, UpdateRoomSongPool,
};
use shared::setlist::{
...
#[openapi(
    ...
    paths(
        ...
        crate::resources::room::rest::list_rooms,
        crate::resources::room::rest::create_room,
        crate::resources::room::rest::get_room,
        crate::resources::room::rest::join_room,
        crate::resources::room::rest::update_song_pool,
        crate::resources::room::rest::get_pool_songs,

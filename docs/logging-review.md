...
Room invite secrets, participant resume credentials, and connection tickets are never valid log, trace, metric, audit, URL, or Problem Detail fields. Room and participant IDs may be logged for operational correlation after authorization succeeds.
